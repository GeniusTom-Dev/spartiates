...
<div class="w-full p-4">
    ...
    <div class="w-full flex justify-center items-center text-xl md:text-2xl lg:text-4xl mb-4 space-x-6">
        ...
        <div class="bg-customBlue w-[15vw] sm:w-[10vw] md:w-[8.5vw] lg:w-[7vw] xl:w-[5.5vw] 2xl:w-[7vw] p-3 rounded"><img src="/assets/images/qr-code.png" class="w-full items-center"></div>
    </div>
